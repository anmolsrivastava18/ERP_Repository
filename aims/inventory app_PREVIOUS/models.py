...
class Parts(models.Model):
    ...
    dimensions = models.CharField(
        ...
        help_text='Part Dimensions',
    )

    tech_spec = models.CharField(
        blank=True,
        max_length=120,
        verbose_name='Tech Spec',
        help_text='Tech Specifications',
    )
...
class Warehouse(models.Model):
    ...
    incharge_phone_number = models.CharField(
        ...
        verbose_name='Incharge Number',
        help_text='Warehouse Incharge Number',
    )
    aims_person = models.CharField(
        null=False,
        blank=False,
        max_length=120,
        verbose_name='AIMS Person',
        help_text='AIMS Person',
    )
    aims_person_phone_number = models.CharField(
        validators=[phone_regex],
        max_length=17, blank=True,
        verbose_name='AIMS Person Number',
        help_text='AIMS Person Number',
    )
    remarks = models.CharField(
        null=True,
        blank=True,
...
class Domesticinvoice(models.Model):
    ...
    invoice_gst = models.DecimalField(
        ...
        max_digits=12,
        validators=[MinValueValidator(Decimal('0.00'))],
        verbose_name='Invoice GST Percentage',
        help_text='Invoice GST (%)'
    )
    ...
    def save(self, *args, **kwargs):
        """Calculate sum before saving."""
        self.price_per_part = self.total_invoice_amount / self.invoice_quantity
        self.vendor_code = self.get_vendor_code()
        super(Domesticinvoice, self).save(*args, **kwargs)
