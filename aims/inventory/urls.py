...
from ..inventory.views import (
    ...
    IndividualDomesticinvoiceListView,
    IndividualDomesticinvoiceListJson,
    IndividualDomesticinvoiceUpdateView,
    IndividualDomesticinvoiceDetailView,
    IndividualDomesticinvoiceCreateView,
    InwardListView,
    InwardListJson,
    InwardCreateView,
    InwardDetailView,
    ...
    cron_health, get_partID_partName_uomID)
...
urlpatterns = [
    ...
    path('get_partID_partName_uomID', get_partID_partName_uomID, name='get_partID_partName_uomID'),
    ...
    # Individual Domestic Invoice URLs
    path('IndividualDomesticInvoices/', IndividualDomesticinvoiceListView.as_view(),
         name='individual_domestic_invoice-list'),

    path(
        'IndividualDomesticInvoices/add/',
        IndividualDomesticinvoiceCreateView.as_view(),
        name='individual_domestic_invoice-add'
    ),

    path(
        'IndividualDomesticInvoice-list-json/',
        IndividualDomesticinvoiceListJson.as_view(),
        name='individual_domestic_invoice-list-data'
    ),

    path(
        'IndividualDomesticInvoices/<pk>/edit/',
        IndividualDomesticinvoiceUpdateView.as_view(),
        name='individual_domestic_invoice-update'
    ),

    path(
        'IndividualDomesticInvoices/detail/<slug:slug>/',
        IndividualDomesticinvoiceDetailView.as_view(),
        name='individual_domestic_invoice-detail'
    ),
